...
config.nf.parameters.delta = -5:1:5;
...
config.nf.focalDirectionsL.x = @(delta) reshape(sin(deg2rad(-25:5:25)),size(delta));
config.nf.focalDirectionsL.y = @() 0;
config.nf.focalDirectionsL.z = @(delta) reshape(cos(deg2rad(-25:5:25)),size(delta));

config.nf.focalDirectionsV.x = @(delta) reshape(sin(deg2rad(25:-5:-25)),size(delta));
config.nf.focalDirectionsV.y = @() 0;
config.nf.focalDirectionsV.z = @(delta) reshape(cos(deg2rad(25:-5:-25)),size(delta));
