function [throughputVmf] = movmfThroughput2D(apertureVmf,x,signz,sigt,dz)
...
throughputVmf = movmfMultiple2D(apertureVmf,tmp_throughputVmf,true);
throughputVmf.focalDim = apertureVmf.focalDim;
end
