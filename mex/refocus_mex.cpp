...
void parseError(calc_size_return errVal)
{
    ...
    {
        case ERR_K:
            mexErrMsgIdAndTxt("refocus:inputSize:k","Wrong input size of k."); break;
        case ERR_LIGHT_P_X:
            mexErrMsgIdAndTxt("refocus:inputSize:lpx","Wrong input size of x light position."); break;
        case ERR_LIGHT_P_Y:
            mexErrMsgIdAndTxt("refocus:inputSize:lpy","Wrong input size of y light position."); break;
        case ERR_LIGHT_P_Z:
            mexErrMsgIdAndTxt("refocus:inputSize:lpz","Wrong input size of z light position."); break;
        case ERR_LIGHT_D_X:
            mexErrMsgIdAndTxt("refocus:inputSize:ldx","Wrong input size of x light direction."); break;
        case ERR_LIGHT_D_Y:
            mexErrMsgIdAndTxt("refocus:inputSize:ldy","Wrong input size of y light direction."); break;
        case ERR_LIGHT_D_Z:
            mexErrMsgIdAndTxt("refocus:inputSize:ldz","Wrong input size of z light direction."); break;
        case ERR_VIEW_P_X:
            mexErrMsgIdAndTxt("refocus:inputSize:vpx","Wrong input size of x view position."); break;
        case ERR_VIEW_P_Y:
            mexErrMsgIdAndTxt("refocus:inputSize:vpy","Wrong input size of y view position."); break;
        case ERR_VIEW_P_Z:
            mexErrMsgIdAndTxt("refocus:inputSize:vpz","Wrong input size of z view position."); break;
        case ERR_VIEW_D_X:
            mexErrMsgIdAndTxt("refocus:inputSize:vdx","Wrong input size of x view direction."); break;
        case ERR_VIEW_D_Y:
            mexErrMsgIdAndTxt("refocus:inputSize:vdy","Wrong input size of y view direction."); break;
        case ERR_VIEW_D_Z:
            mexErrMsgIdAndTxt("refocus:inputSize:vdz","Wrong input size of z view direction."); break;
        case ERR_LIGHT_P_X_2:
            mexErrMsgIdAndTxt("refocus:inputSize:lpx2","Wrong input size of x light position of u2."); break;
        case ERR_LIGHT_P_Y_2:
            mexErrMsgIdAndTxt("refocus:inputSize:lpy2","Wrong input size of y light position of u2."); break;
        case ERR_LIGHT_P_Z_2:
            mexErrMsgIdAndTxt("refocus:inputSize:lpz2","Wrong input size of z light position of u2."); break;
        case ERR_LIGHT_D_X_2:
            mexErrMsgIdAndTxt("refocus:inputSize:ldx2","Wrong input size of x light direction of u2."); break;
        case ERR_LIGHT_D_Y_2:
            mexErrMsgIdAndTxt("refocus:inputSize:ldy2","Wrong input size of y light direction of u2."); break;
        case ERR_LIGHT_D_Z_2:
            mexErrMsgIdAndTxt("refocus:inputSize:ldz2","Wrong input size of z light direction of u2."); break;
        case ERR_VIEW_P_X_2:
            mexErrMsgIdAndTxt("refocus:inputSize:vpx2","Wrong input size of x view position of u2."); break;
        case ERR_VIEW_P_Y_2:
            mexErrMsgIdAndTxt("refocus:inputSize:vpy2","Wrong input size of y view position of u2."); break;
        case ERR_VIEW_P_Z_2:
            mexErrMsgIdAndTxt("refocus:inputSize:vpz2","Wrong input size of z view position of u2."); break;
        case ERR_VIEW_D_X_2:
            mexErrMsgIdAndTxt("refocus:inputSize:vdx2","Wrong input size of x view direction of u2."); break;
        case ERR_VIEW_D_Y_2:
            mexErrMsgIdAndTxt("refocus:inputSize:vdy2","Wrong input size of y view direction of u2."); break;
        case ERR_VIEW_D_Z_2:
            mexErrMsgIdAndTxt("refocus:inputSize:vdz2","Wrong input size of z view direction of u2."); break;
    }
}
    
void parseError(run_return errVal)
{
    switch(errVal)
    {
        case ERR_GPU_DEVICE:
            mexErrMsgIdAndTxt("refocus:gpu:gpuNum","Bad GPU number."); break;
        case ERR_BAD_MEM_ALLOCATION:
            mexErrMsgIdAndTxt("refocus:mem:allocation","Bad memory allocation."); break;
    }
}
...
input_st<T,T2,T3>* initMex(int nrhs, const mxArray *prhs[])
{
    ...
    {
        mexErrMsgIdAndTxt("refocus:dims:number","vector dims number in refocus must be 3D.");
    }
    ...
    {
        mexErrMsgIdAndTxt("refocus:scattering:flag","Invalid scattering flag.");
    }
    ...
    if(dataHandler->scattering_input.type == 2)
    {
        ...
        {
            mexErrMsgIdAndTxt("refocus:scattering:tabulated","maximal tabulated entries allowed is 1048576.");
        }
    ...
    if(dataHandler->scattering_input.type == 3)
    {
        ...
        {
            mexErrMsgIdAndTxt("refocus:scattering:g","g value must be smaller than 1.");
        }
    }

    // refocus
    dataHandler->refocus.sample_forward = *mxGetUint32s(mxGetField(prhs[REFOCUS], 0, "sample_forward"));
    dataHandler->refocus.sample_backward = *mxGetUint32s(mxGetField(prhs[REFOCUS], 0, "sample_backward"));
    
    if(!dataHandler->refocus.sample_forward && !dataHandler->refocus.sample_backward)
    {
        mexErrMsgIdAndTxt("refocus:refocus:zdir","at least one of the forward or backward must be true");
    }
    
    dataHandler->refocus.bias_attenuation = *mxGetUint32s(mxGetField(prhs[REFOCUS], 0, "bias_attenuation"));
    dataHandler->refocus.binary_aperture = *mxGetUint32s(mxGetField(prhs[REFOCUS], 0, "binary_aperture"));
    dataHandler->refocus.max_xy_value = *mxGetDoubles(mxGetField(prhs[REFOCUS], 0, "max_xy_value"));
    dataHandler->refocus.sample_random = *mxGetUint32s(mxGetField(prhs[REFOCUS], 0, "sample_random"));
    dataHandler->refocus.tabulated_dldv = *mxGetDoubles(mxGetField(prhs[REFOCUS], 0, "tabulated_dldv"));
    dataHandler->refocus.random_directions_number = *mxGetUint32s(mxGetField(prhs[REFOCUS], 0, "random_directions_number"));
                 ...
                 int nrhs, const mxArray *prhs[])
{
    // Check input
    if(nrhs != 8) {
        mexErrMsgIdAndTxt("refocus:arrayProduct:nrhs",
                          "8 inputs required.");
    ...
    if(precisionType)
    {
        ...
        parseError(calculate_size<double,double2,double3>(dataHandler));
        ...
        parseError(refocus_run<double,double2,double3>(dataHandler,(double2 *)mxGetComplexDoubles(u),(double2 *) mxGetComplexDoubles(us),
    ...
    else
    {
        ...
        parseError(calculate_size<float,float2,float3>(dataHandler));
        ...
        parseError(refocus_run<float,float2,float3>(dataHandler,(float2 *)mxGetComplexSingles(u),(float2 *)mxGetComplexSingles(us),
                (double *) mxGetDoubles(norm_factor), (ub64 *) mxGetUint64s(total_iterations) ));
