function [u]=MCfieldAp(sigt,albedo,box_min,box_max,l,v,is_ff_l,is_ff_v,maxItr,lambda,doCBS,smpFlg,sct_type,ampfunc,ampfunc0,lmean0,ap_win)
...
for itr=1:maxItr
   %itr
    ...
    % and the sensors
    e_v0=evalphaseattAp(x,ff_sign*v,is_ff_v,sigt,lambda,box_min,box_max,ap_win);
    ...
    while 1
        ...
        if (pL>1)
            e_v=evalphaseattAp(x,ff_sign*v,is_ff_v,sigt,lambda,box_min,box_max,ap_win);
