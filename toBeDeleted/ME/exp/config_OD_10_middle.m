config.boxDepth = 1000;
config.focalPointsV.base = -200:4:200;
config.focalPointsL.base = [0:2:20,30:10:70,200:200:1200];
config.focalPointsL.plain = -config.boxDepth/2 - 1000;
