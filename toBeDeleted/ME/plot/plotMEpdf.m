...
hold on
plotDisplacement(expirementsRes.config_OD_1_nf.config, expirementsRes.config_OD_1_nf.C, OD1color,'-');
plotDisplacement(expirementsRes.config_OD_1_middle.config, expirementsRes.config_OD_1_middle.C, OD1color,'--');
plotDisplacement(expirementsRes.config_OD_1_ff.config, expirementsRes.config_OD_1_ff.C, OD1color,':');

plotDisplacement(expirementsRes.config_OD_5_nf.config, expirementsRes.config_OD_5_nf.C, OD5color,'-');
plotDisplacement(expirementsRes.config_OD_5_middle.config, expirementsRes.config_OD_5_middle.C, OD5color,'--');
plotDisplacement(expirementsRes.config_OD_5_ff.config, expirementsRes.config_OD_5_ff.C, OD5color,':');

plotDisplacement(expirementsRes.config_OD_10_nf.config, expirementsRes.config_OD_10_nf.C, OD10color,'-');
plotDisplacement(expirementsRes.config_OD_10_middle.config, expirementsRes.config_OD_10_middle.C, OD10color,'--');
...
config = expirementsRes.config_OD_1_nf.config;
DL = abs(config.focalPointsL.plain) + abs(config.boxDepth/2);
angles =  atan(config.focalPointsL.base / DL);
plotAngle(expirementsRes.config_OD_1_nf.C,angles,OD1color,'-');

config = expirementsRes.config_OD_1_middle.config;
DL = abs(config.focalPointsL.plain) + abs(config.boxDepth/2);
angles =  atan(config.focalPointsL.base / DL);
plotAngle(expirementsRes.config_OD_1_middle.C,angles,OD1color,'--');
...
config = expirementsRes.config_OD_5_nf.config;
DL = abs(config.focalPointsL.plain) + abs(config.boxDepth/2);
angles =  atan(config.focalPointsL.base / DL);
plotAngle(expirementsRes.config_OD_5_nf.C,angles,OD5color,'-');

config = expirementsRes.config_OD_5_middle.config;
DL = abs(config.focalPointsL.plain) + abs(config.boxDepth/2);
angles =  atan(config.focalPointsL.base / DL);
plotAngle(expirementsRes.config_OD_5_middle.C,angles,OD5color,'--');

config = expirementsRes.config_OD_5_ff.config;
DL = abs(config.focalPointsL.plain) + abs(config.boxDepth/2);
angles =  atan(config.focalPointsL.base / DL);
plotAngle(expirementsRes.config_OD_5_ff.C,angles,OD5color,':');

load('MEcor_Jan192020_od5.mat')
angles = atan(l(1,:));
plotAngle2(ncC, angles,'k',':');

config = expirementsRes.config_OD_10_nf.config;
DL = abs(config.focalPointsL.plain) + abs(config.boxDepth/2);
angles =  atan(config.focalPointsL.base / DL);
plotAngle(expirementsRes.config_OD_10_nf.C,angles,OD10color,'-');

config = expirementsRes.config_OD_10_middle.config;
DL = abs(config.focalPointsL.plain) + abs(config.boxDepth/2);
angles =  atan(config.focalPointsL.base / DL);
plotAngle(expirementsRes.config_OD_10_middle.C,angles,OD10color,'--');
