...
%% Sample
config.medium.dim = 3;
config.medium.MFP = 50;
config.medium.boxDepth = 300;
config.medium.boxAxial = 1e5;
config.medium.boxShift = [0;0;0];

%% ff parameters
config.ff.parameters.vx = -0.3:0.01:0.3;
config.ff.parameters.vy = -0.3:0.01:0.3;
config.ff.parameters.dl = 0:0.002:0.06;
